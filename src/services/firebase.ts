...
import { getAuth, connectAuthEmulator } from "firebase/auth"; // Keep connectAuthEmulator imported for now
...
if (process.env.NODE_ENV === 'development') {
    console.log("Connecting to Firebase Auth Emulator... (This line is now commented out)");
    // connectAuthEmulator(auth, "http://127.0.0.1:9099"); // <-- THIS LINE IS COMMENTED OUT
}
